...
$(function() {
	...
	$('.content', '.full-notice, .feed-item').html((i,html) => {
		...
		html = html.replace(/(Baron(?:ess)? .+?\b(?: of .+?\b)?)(,| of .*? in )/g, '<a href="https://en.wikipedia.org/w/index.php?search=$1&title=Special%3ASearch&go=Go&ns0=1">$1</a>$2')

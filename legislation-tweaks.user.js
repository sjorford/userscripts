...
$(function() {
	...
	$('#viewLegSnippet *').contents().filter((i,e) => e.nodeType == 3).each((i,e) => {
		var match;
		while (match = e.nodeValue.match(/^(.*?)(?<!\d)(\d{4}|(\d+|(twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety)(-(nine|eight|seven|six|five|four|three|two|one))?|nine|eight|seven|six|five|\w+teen\b|ten|eleven|twelve|oodles) ((county|district) )?(electoral )?(wards|divisions)|is (\d|one|two|three|four|five|six))(?!\d)(.*)$/s)) {
